    ...
    <>
      ...
      <div className={styles.appContainer}>
        ...
        <main className={styles.mainContent}>
          ...
          <div className='home-header' style={{ background: 'rgba(255, 255, 255, 0.25)', backdropFilter: 'blur(15px)', padding: '10px 35px', borderRadius: '50px', border: '1px solid rgba(255, 255, 255, 0.3)' }}>
